...
- [ ] Admin pages:
    ...
    - [X] fix vertical gap of back link and "new" button.
...
- [ ] Figure out an "ID" for the interface of the application:
    - [ ] fonts;
    - [ ] color palette.
- [X] Unify management of "types" and "categories" on a single screen.
...
\* Refer to Mr. Copilot's documentation standards.